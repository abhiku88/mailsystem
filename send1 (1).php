...
<?php
 ...
 if(isset($_POST["email"])) {
    ...
    ."<br/><br/>"."datetime: ".$_POST["datetime"]
    ."<br/><br/>"."Email: ".$_POST["email"]
    ."<br/><br/>"."Phone: ".$_POST["phone"]
    ."<br/><br/>"."Address:".$_POST["address"]
    ."<br/><br/>"."Buss. Clean Inside:".$_POST["insidebussone"]
    ."<br/><br/>"."Buss. Clean Outside:".$_POST["outsidebussone"]
    ."<br/><br/>"."Buss. Area Size:".$_POST["bussarea"]
    ."<br/><br/>"."Home clean Inside:".$_POST["insidehomeone"]
    ."<br/><br/>"."Home clean Outside:".$_POST["outsidehomeone"]
    ."<br/><br/>"."Home Area Size:".$_POST["homearea"]
    ."<br/><br/>"."Car Clean Inside:".$_POST["carinsideone"]
    ."<br/><br/>"."Car Clean Outside:".$_POST["caroutsideone"]
    ."<br/><br/>"."Car Area:".$_POST["cararea"]
    ."<br/><br/>"."Message:".$_POST["messagee"]
    ;
